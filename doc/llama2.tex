...
\subsection{Glossary}
  ...
  \begin{table}[hbtp]
    ...
    \begin{tabular}{|l||l|l|l|} \hline \hline
      {\bf Abbreviation} & {\bf C code} &  XX& {\bf Dimensions}   \\ \hline 
      \(n_V\) & {\tt vocab\_size} & 0 & \\ \hline
      \(n_D\) & {\tt dim} & 0 & \\ \hline
      \(n_H\) & {\tt n\_heads} & 0 & \\ \hline
      \(s_H\) & {\tt head\_size} & 0 & \\ \hline
      \(n_{HKV}\) & {\tt n\_kv\_heads} & 0 & \\ \hline
      \(n_D\) & {\tt dim} & 0 & \\ \hline
      \(n_D'\) & {\tt ispc\_dim} & 0 & \\ \hline
      \hline
      \hline
      ...
      \(W_{ra}\) & rms att weight & 2 & \(n_L \times n_D \) \\ \hline
      \(W_q\) & w\_q & 3 & \(n_L \times n_D \times (n_H \times s_H)\) \\ \hline
      \(W_k\) & w\_k & 3 & \(n_L \times n_D \times (n_{HK} \times s_H)\) \\ \hline
      \(W_v\) & w\_v & 3 & \(n_L \times n_D \times (n_{HK} \times s_H)\) \\ \hline
      \(W_o\) & w\_o & 3 & \(n_L \times (n_H \times s_H) \times n_D\) \\ \hline
    \hline
    \end{tabular}
      \caption{Mapping math notation to C code} 
      \label{math_notation}
  \end{table}
...
Input Arguments in Table~\ref{args_rmsnorm}
  \begin{table}[hbtp]
    \centering
...
Output arguments
\be
\item \(o\), {\tt float} vector of length \(n\) 
  \ee
